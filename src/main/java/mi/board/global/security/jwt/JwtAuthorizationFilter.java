package mi.board.global.security.jwt;
...
import mi.board.global.security.exception.JwtPrefixException;
...
import static mi.board.global.enums.ErrorCode.JWT_PREFIX_ERROR;
...
public class JwtAuthorizationFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
		...
		try {
			...
			log.info("Extracted username from token: {}", info.getSubject());
			// 사용자 인증 정보 설정
